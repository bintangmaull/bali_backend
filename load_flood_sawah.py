"""
Load flood sawah loss values from CSV into loss_flood_sawah table.
Run this once from the backend root:
    python load_flood_sawah.py
"""
import sys
import os
import csv
...
CSV_PATH = r'E:\Dashboard\Data\Hasil\hasilsawah\Fixed Result - Rice Field\flood_loss_value.csv'
